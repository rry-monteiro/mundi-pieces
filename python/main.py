...
MOUSE_ON_POSITIONS=[
        cvetor(mt.pi,            0,         r=.2),
        cvetor(3131*mt.pi/7200,  5*mt.pi/4, r=.2),
        cvetor(3131*mt.pi/720,   5*mt.pi/4, r=.2),
        cvetor(469*mt.pi/7200,   5*mt.pi/4, r=.2),
        cvetor(3131*mt.pi/7200,  mt.pi/4,   r=.2),
        cvetor(mt.pi/4,          mt.pi/4,   r=.2),
        cvetor(469*mt.pi/7200,   mt.pi/4,   r=.2),]
